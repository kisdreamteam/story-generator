...
export interface AIPromptSetupSection {
  storyPurpose: string
  storyTone: string
  theme: string
  setting: string
...
export interface AIPromptStructureSection {
  pageCount: number
  seriesName: string
}

/** Character and illustration continuity rules. */
export interface AIPromptContinuitySection {
  characterNotes: string
  visualStyleNotes: string[]
}

/** Vocabulary and language-learning targets. */
export interface AIPromptVocabularySection {
...
export interface AIPromptOutputRequirementsSection {
...
export interface AIPromptContract {
  setup: AIPromptSetupSection
  storyStructure: AIPromptStructureSection
  continuity: AIPromptContinuitySection
  vocabulary: AIPromptVocabularySection
  outputRequirements: AIPromptOutputRequirementsSection
}
...
export function buildAIPromptContract(input: AIStoryGenerationInput): AIPromptContract {
  const { setup } = input
